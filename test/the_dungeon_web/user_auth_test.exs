defmodule TheDungeonWeb.UserAuthTest do
  use TheDungeonWeb.ConnCase, async: true

  alias TheDungeon.Accounts
  alias TheDungeon.Accounts.Scope
  alias TheDungeonWeb.UserAuth

  import TheDungeon.AccountsFixtures

  @remember_me_cookie "_the_dungeon_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TheDungeonWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
